...
// Define the package address from the generated types' DEFAULT_OPTIONS
// This address is typically constant for your deployed package.
const PACKAGE_ADDRESS = "0x4fb1cf45dffd6230305f1d269dd1816678cc8e3ba0b747a813a556921219f261";


events.bind()
    .onEventEvent(async (eventInstance, ctx) => {
        // Log the raw event to see if anything is coming through
        console.log("Received a generic wrapped event:", JSON.stringify(eventInstance));
        ...
        console.log(`Processing wrapped event type: ${wrappedEventType}`);
        console.log(`Wrapped event data: ${JSON.stringify(eventData)}`);
        ...
        switch (wrappedEventType) {
            case poolTypes.SwapResult.TYPE_QNAME:
                ...
                console.log(`Logged SwapResult for user: ${swapData.user}`);
                break;
            ...
            case registryTypes.PoolData.TYPE_QNAME:
                ...
                console.log(`Logged PoolData for pool: ${poolData.pool_id}`);
                break;
            case poolTypes.NewPoolResult.TYPE_QNAME:
                ...
                console.log(`Logged NewPoolResult for pool: ${newPoolData.pool_id}`);
                break;
            case poolTypes.RedeemResult.TYPE_QNAME:
                ...
                console.log(`Logged RedeemResult for user: ${redeemData.user}`);
                break;
                case poolTypes.DepositResult.TYPE_QNAME:
                    ...
                    console.log(`Logged DepositResult for user: ${depositData.user}`);
                    break;
                case bankTypes.BurnBTokenEvent.TYPE_QNAME:
                    ...
                    console.log(`Logged BurnBTokenEvent for user: ${burnBTokenData.user}`);
                    break;
                case bankTypes.DeployEvent.TYPE_QNAME:
                    ...
                    console.log(`Logged DeployEvent for bank: ${deployData.bank_id}`);
                    break;
                case bankTypes.MintBTokenEvent.TYPE_QNAME:
                    ...
                    console.log(`Logged MintBTokenEvent for user: ${mintBTokenData.user}`);
                    break;
                case bankTypes.NeedsRebalance.TYPE_QNAME:
                    ...
                    console.log(`Logged NeedsRebalance event`);
                    break;
                case bankTypes.NewBankEvent.TYPE_QNAME:
                    ...
                    console.log(`Logged NewBankEvent for bank: ${newBankData.bank_id}`);
                    break;
                case bankTypes.RecallEvent.TYPE_QNAME:
                    ...
                    console.log(`Logged RecallEvent for bank: ${recallData.bank_id}`);
                    break;
                case registryTypes.BankKey.TYPE_QNAME:
                    ...
                    console.log(`Logged BankKey event for lending market: ${bankKeyData.lending_market_id}`);
                    break;
                case registryTypes.PoolKey.TYPE_QNAME:
                    ...
                    console.log(`Logged PoolKey event`);
                    break;
                case feesTypes.FeeConfig.TYPE_QNAME:
                    ...
                    console.log(`Logged FeeConfig event`);
                    break;
                case quoteTypes.DepositQuote.TYPE_QNAME:
                    ...
                    console.log(`Logged DepositQuote event`);
                    break;
                case quoteTypes.RedeemQuote.TYPE_QNAME:
                    ...
                    console.log(`Logged RedeemQuote event`);
                    break;
                case quoteTypes.SwapFee.TYPE_QNAME:
                    ...
                    console.log(`Logged SwapFee event`);
                    break;
                case quoteTypes.SwapQuote.TYPE_QNAME:
                    ...
                    console.log(`Logged SwapQuote event`);
                    break;
            default:
                console.log(`Unrecognized wrapped event type: ${wrappedEventType}`);
                break;
        }
    });